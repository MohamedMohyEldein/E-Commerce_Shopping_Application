    ...
    public partial class Initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    CategoryId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    ProductId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    CartId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    ProductVariantId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    OrderId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    ProductVariantId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    WishlistId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    ProductVariantId = table.Column<string>(type: "varchar(26)", unicode: false, maxLength: 26, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wish_list_item", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Wish_list_item_Product_variant_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "Product_variant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Wish_list_item_Wish_list_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wish_list_item_ProductVariantId",
                table: "Wish_list_item",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_Wish_list_item_WishlistId",
                table: "Wish_list_item",
                column: "WishlistId");
        }
